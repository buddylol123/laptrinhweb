                                ...
                                <div class="col-12 px-md-4 border-top border-left sidebar h-100">
                                    ...
                                    <div class="row">
                                        <div class="col-12 mt-md-0 mt-3 text-uppercase">
                                            <h2><u>Lượt thích và đánh giá</u></h2>
                                        </div>
                                        <div class="col-12">
                                            <div class="row">
                                        ...
                                        <div class="col-12">
                                            <form>
                                                <div class="form-group">
                                                    <textarea class="form-control" placeholder="Điền thông tin vào"></textarea>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <button class="btn btn-outline-dark">Đánh giá sản phẩm</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="col-12 text-justify py-2 mb-3 bg-gray">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        GIỚI THIỆU SẢN PHẨM BÌNH ĐUN SIMPLEHOME D1818 1,7 LÍT
Kiểu dáng bắt mắt.
Bình đun SIMPLEHOME D1818 1,7 Lít có thiết kế sang trọng, vẻ ngoài sáng bóng góp phần làm nổi bật không gian bếp nhà bạn. Chất liệu nhựa chống trầy xước, trải qua thời gian dài sử dụng thì vỏ bình cũng sẽ như mới. Khi tiến hành vệ sinh cũng tương đối tiện lợi, giúp chị em ít tốn công sức. Với dung tích 1.7 lí
                                                        <br>
                                                        GIỚI THIỆU SẢN PHẨM BÌNH ĐUN SIMPLEHOME D1818 1,7 LÍT
                                                        Kiểu dáng bắt mắt.
                                                        Bình đun SIMPLEHOME D1818 1,7 Lít có thiết kế sang trọng, vẻ ngoài sáng bóng góp phần làm nổi bật không gian bếp nhà bạn. Chất liệu nhựa chống trầy xước, trải qua thời gian dài sử dụng thì vỏ bình cũng sẽ như mới. Khi tiến hành vệ sinh cũng tương đối tiện lợi, giúp chị em ít tốn công sức. Với dung tích 1.7 lí                                                        <br>
                                                    </div>
                                                    <div class="col-12">
                                                        <small>
                                    ...
                                    <div class="col-lg-3 col-sm-6 my-3">
                                        <div class="col-12 bg-white text-center h-100 product-item">
                                            <div class="row h-100">
                                                ...
                                                <div class="col-12 mb-3 align-self-end">
                                                    <button class="btn btn-outline-dark" type="button"><i class="fas fa-cart-plus mr-2"></i>Thêm vào giỏ hàng</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6 my-3">
                                        <div class="col-12 bg-white text-center h-100 product-item">
                                            <div class="row h-100">
                                                ...
                                                <div class="col-12 mb-3">
                                                    <a href="product.html" class="product-name">Ấm đun nước</a>
                                                </div>
                                                <div class="col-12 mb-3">
                                                    <span class="product-price">
                                                        $4,500
                                                ...
                                                <div class="col-12 mb-3 align-self-end">
                                                    <button class="btn btn-outline-dark" type="button"><i class="fas fa-cart-plus mr-2"></i>Thêm</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
